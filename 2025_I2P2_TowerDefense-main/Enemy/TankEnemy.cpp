...
TankEnemy::TankEnemy(int x, int y)
    : Enemy("play/enemy-3.png", x, y, 20, 20, 100, 50),
      head(new Sprite("play/enemy-3-head.png", x, y)), targetRotation(0) {
}
...
void TankEnemy::SetHead(unsigned char r, unsigned char g, unsigned char b, unsigned char a) {
    if (head) {
        head->Tint = al_map_rgba(r, g, b, a);
    }
}